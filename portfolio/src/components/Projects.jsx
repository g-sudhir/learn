      ...
      <div className="w-full">
        <div className="flex flex-col px-10 py-5">
          ...
          <p>
            ...
            MERN and vanila CSS. Check them out.
          </p>
        </div>
      </div>
      <div className="w-full">
          ...
          <div className="relative">
            ...
            <div className="project-desc">
              <p className="text-center py-5 px-5">
                A Ecommerce Website. Built with MERN Stack.
              </p>
            </div>
          </div>
          <div className="relative">
            ...
            <div className="project-desc">
              <p className="text-center py-5 px-5">
                Website for a Company. Built with MERN Stack.
              </p>
            </div>
          </div>
          {/* <div className="relative">
            ...
            <div className="project-desc">
              <p className="text-center py-5">
                Basic Blog Website. Built with Next JS and MongoDB
              </p>
            </div>
          </div> */}
        </div>
